      ...
      rules={[
        {
          ...
          validator: (_, value) => {
            ...
            if (
              ...
              notification.error({
                message: t.common.error,
                description: t.rubrics.levels.errorAllValues.replace(
                  '{indicator}',
                  indicador + 1
                ),
              })
            ...
            if (
              ...
              notification.error({
                message: t.common.error,
                description: t.rubrics.levels.errorRangeIndicator.replace(
                  '{indicator}',
                  indicador + 1
                ),
              })
            ...
            if (areThereDuplicates) {
              notification.error({
                message: t.common.error,
                description: t.rubrics.levels.errorDuplicateIndicator.replace(
                  '{indicator}',
                  indicador + 1
                ),
              })
            ...
            if (difference.length > 0) {
              notification.error({
                message: t.common.error,
                description: t.rubrics.levels.errorMissingIndicator
                  .replace('{notes}', difference.join(', '))
                  .replace('{indicator}', indicador + 1),
              })
              return Promise.reject(
                new Error(
                  t.rubrics.levels.errorMissing.replace(
                    '{notes}',
                    difference.join(', ')
                  )
                )
